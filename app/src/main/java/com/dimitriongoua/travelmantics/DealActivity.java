...
public class DealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intentImage.setType("image/jpeg");
                intentImage.putExtra(Intent.EXTRA_LOCAL_ONLY, true);
                startActivityForResult(Intent.createChooser(intentImage, "Insert Picture"), PICTURE_RESULT);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.save_meu).setVisible(FirebaseUtil.isAdmin);
